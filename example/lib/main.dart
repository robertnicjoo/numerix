      ...
      home: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Formatted with separators:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatWithSeparators(number)),
              const SizedBox(height: 16),

              Text('Compact format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatCompact(compactNumber)),
              const SizedBox(height: 16),

              Text('Ordinal format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatOrdinal(ordinalNumber)),
              const SizedBox(height: 16),

              Text('Currency format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatCurrency(currencyNumber, symbol: '\$', symbolBefore: true)),
              const SizedBox(height: 16),

              Text('Percentage format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatPercentage(percentageNumber)),
              const SizedBox(height: 16),

              Text('Parse formatted number:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.parseFormattedNumber(formattedString)),
              const SizedBox(height: 16),

              Text('Significant digits format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatSignificantDigits(significantNumber, 3)),
              const SizedBox(height: 16),

              Text('Fractional format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatFractional(fractionalNumber)),
              const SizedBox(height: 16),

              Text('Roman numerals:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.convertToRomanNumerals(romanNumber)),
              const SizedBox(height: 16),

              Text('Number to words:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.numberToWords(wordsNumber)),
              const SizedBox(height: 16),

              Text('Scientific notation:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatScientificNotation(scientificNumber)),
              const SizedBox(height: 16),

              Text('Byte size format:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatByteSize(byteSizeNumber)),
              const SizedBox(height: 16),

              Text('Number with padding:', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.formatWithPadding(paddedNumber, 5)),
              const SizedBox(height: 16),

              Text('Clamped number (0 to 100):', style: Theme.of(context).textTheme.titleMedium),
              Text(_numerix.clampNumber(clampTestNumber, 0, 100)),
              const SizedBox(height: 16),

              Text('Duration format (h m s):', style: Theme.of(context).textTheme.titleMedium),
